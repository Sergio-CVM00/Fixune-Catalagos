export default function Mapita (){
    return(
              <div className="h-full px-4 py-4 mx-auto my-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-48">
                    ...
                    <div className="grid content-center gap-5 row-gap-8 sm:grid-cols-2" >
                      <div className="bg-white border-l-4 shadow-sm">
                        <div className="h-full p-5 border border-l-0 rounded-r">
                          <h6 className="mb-2 text-lg font-semibold leading-5 text-gray-900 capitalize">
                             nº de teléfono:
                          </h6>
