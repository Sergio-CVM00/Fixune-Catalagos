            ...
            <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
                ...
                <div className="flex flex-col justify-center md:pr-8 xl:pr-0 lg:max-w-lg">
                    <div className="max-w-xl mb-6">
                        <h2 className="max-w-lg mb-6 font-sans text-4xl font-bold leading-none tracking-tight text-gray-50 sm:text-5xl">
                            Dejalo en nuestras manos
                        </h2>
                        <p className="text-base antialiased font-semibold tracking-tight text-gray-900 md:text-lg" >
                    ...
                    <div>
                        <Link href="../contacto">
                            <a
                                ...
                                aria-label=""
                                className="inline-flex items-center text-lg font-bold duration-200 texttransition-colors text-gray-50 hover:text-gray-200"
                            >
